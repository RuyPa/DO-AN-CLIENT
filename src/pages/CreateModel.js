...
//   const [samples, setSamples] = useState([]); // Lưu trữ các mẫu lấy từ API
//   const [selectedSamples, setSelectedSamples] = useState([]); // Lưu trữ các mẫu được chọn
